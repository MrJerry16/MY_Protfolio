  ...
  const professionalExperiences = [
    {
      ...
      highlights: [
        "Developed a React.js admin panel, integrating REST APIs to enable real-time data across 5+ modules, improving workflow efficiency by 25%..",
        "Performed end-to-end testing and debugging, reducing UI defects by 30% before production release.",
        "Collaborated with cross-functional teams using Agile practices to deliver features within sprint timelines.",
        "Leveraged AI tools to enhance the UI of a PHP-based platform (VCDial), improving usability and visual appeal, followed by thorough testing for stability.",
      ],
    },
    {
    ...
    },
    {
      ...
      location: "Mumbai, India",
      highlights: [
        "Designed and developed 7+ RESTful APIs using Java, Spring Boot, and Spring Data JPA, applying OOP principles to automate workflows and reduce manual effort by 30%.",
        "Performed system analysis and debugging, resolving 15+ issues and ensuring data integrity across integrated modules.",
        "Conducted data analysis on 10,000+ records using SQL and Python (Pandas), and built dashboards in Tableau to present KPIs and business insights.",
      ],
    },
  ];
